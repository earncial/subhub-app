...
(function () {
  ...
  const CONFIG = {
    ...
    social: {
      ...
      facebook: 'https://www.facebook.com/subhubng',            // ← Replace
    },
    // bot: {
  ...
  const ICONS = {
    ...
    facebookBrand: `<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M22 12.06C22 6.5 17.52 2 12 2S2 6.5 2 12.06c0 5.02 3.66 9.18 8.44 9.94v-7.03H7.9v-2.91h2.54V9.85c0-2.51 1.49-3.9 3.77-3.9 1.09 0 2.24.2 2.24.2v2.46h-1.26c-1.24 0-1.63.77-1.63 1.56v1.88h2.78l-.45 2.91h-2.33V22c4.78-.76 8.44-4.92 8.44-9.94z"/></svg>`,
  ...
  const CSS = `
    ...
    #sh-support-fab .sh-fab-icon { position: relative; width: 26px; height: 26px; }
    #sh-support-fab .sh-fab-icon .sh-icon-open,
    #sh-support-fab .sh-fab-icon .sh-icon-close {
      position: absolute;
      inset: 0;
      display: flex;
      align-items: center;
    ...
    #sh-support-fab .sh-fab-icon svg { display: block; }
    ...
    .sh-social-fb { background: #1877F2; }
      ...
      <div id="sh-support-modal" role="dialog" aria-modal="true" aria-label="SubHub Support" tabindex="-1">
        ...
        <div class="sh-modal-footer">
          ...
          <div class="sh-socials">
            ...
            <a href="${CONFIG.social.facebook}" target="_blank" rel="noopener" class="sh-social-btn sh-social-fb" aria-label="Facebook">${ICONS.facebookBrand}</a>
          </div>
